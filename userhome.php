  ...
  <div class="container">
   <div class="breadcrumb1">
	...
	<a href="userhome.php?id=<?php echo $id?>"><i class="fa fa-home home_1"></i></a>
        ...
        <li class="current-page"><?php echo $_SESSION['username']?>'s profile</li>
	<?endif;?>
     </ul>
   </div>
   <div class="navigation" style="background-color: #ccc;"><!-- Innernavigation starts -->
			...
			<?php if(doesProfileExist($id)) : ?>
		        <ul class="nav navbar-nav nav_1">
		            <li id="view_profile"><a id="view_profile" href="view_profile.php?id=<?php echo $id;?>">View Profile</a></li>
			...
			<?php else:?>
				<li><a href="create_profile.php?id=<?php echo $id;?>">Create Your Profile</a></li>
			<?php endif; ?>
		</div>
