  ...
  <div class="container">
   <div class="breadcrumb1">
	...
	<?php if(isset($_SESSION['id'])) :
		$id = $_SESSION['id'];
	?>
        <a href="userhome.php?id=<?php echo $id?>"><i class="fa fa-home home_1"></i></a>
        <span class="divider">&nbsp;|&nbsp;</span>
        <li class="current-page">Create Your Profile</li>
	<?php endif; ?>
     </ul>
   </div>
   <?php $profileData = getProfileDetails($id); ?>
   <div class="services">
	     ...
	     <form action="" method="POST">
		      ...
		      <input type="text" id="edit-name" name="fname" value="<?php echo isset($profileData["firstname"])?$profileData["firstname"]:""?>" size="60" maxlength="60" class="form-text required">
		    </div>
		    <div class="form-group col-sm-4">
		      <label for="edit-pass">Last Name <span class="form-required" title="This field is required.">*</span></label>
		      <input type="text" id="edit-last" name="lname" value="<?php echo isset($profileData["firstname"])?$profileData["lastname"]:""?>" size="60" maxlength="128" class="form-text required">
		    </div>
		     <div class="form-group col-sm-2">
		      <label for="edit-name">Sex <span class="form-required" title="This field is required.">*</span></label>
			    <div class="select-block1">
	                	<select name="sex">
	                    <option value="Male" <?php isset($profileData["sex"]) ? $profileData["sex"] : "" echo 'selected="selected"'; ?>>Male</option>
	                    <option value="Female" <?php isset($profileData["sex"]) ? $profileData["sex"] : "" echo 'selected="selected"'; ?>>Female</option> 
	                </select>
			    </div>
		    </div>
		    <div class="form-group col-sm-6">
