  ...
  var typed = new Typed('#typed', {
    stringsElement: '#typed-strings',
		...
		<?php if(empty($_SESSION['id'])) : ?>
			<a href="register.php" class="hvr-shutter-out-horizontal btn11">Sign Up</a>
			<a href="login.php" class="hvr-shutter-out-horizontal btn11">Sign In</a>
		<?php endif;?>
		</div>
  </div>
...
<!-- Sliding banner home page start -->
<div class="container"> 
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="images/banners/slide-1.jpg" alt="Los Angeles" style="width:100%;">
      </div>

      <div class="item">
        <img src="images/banners/slide-3.png" alt="Chicago" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="images/banners/slide-5.jpg" alt="New york" style="width:100%;">
      </div>
    </div>
